...
export default function UpgradeModal({ open, onClose }: UpgradeModalProps) {
  ...
  const handleUpgrade = () => {
    // Placeholder: set a localStorage flag. Replace with real billing (Stripe/Polar) later.
            ...
            <div className="px-6 pb-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="rounded-lg border border-border p-4 space-y-3">
                  <div>
                    <p className="text-xs font-mono uppercase tracking-widest text-muted-foreground">Free</p>
                ...
                {/* Pro tier */}
                <div className="rounded-lg border-2 border-primary/50 bg-primary/5 p-4 space-y-3 relative">
                  ...
                  <div>
                    <p className="text-xs font-mono uppercase tracking-widest text-primary">Pro</p>
